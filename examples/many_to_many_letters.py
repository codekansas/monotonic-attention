...
"""Defines a dummy "letters" model which is solvable by the many-to-many model.
...
from monotonic_attention.many_to_many import ManyToManyMultiheadMonotonicAttention
...
class MonotonicSeq2Seq(nn.Module):
    ...
    def __init__(self, vocab_size: int, dim: int, padding_idx: int, use_rnn: bool) -> None:
        ...
        self.attn = ManyToManyMultiheadMonotonicAttention(dim, num_heads=1)
...
if __name__ == "__main__":
    # python -m examples.many_to_many_letters
    main()
